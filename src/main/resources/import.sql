...
INSERT INTO produto (nome, preco_unitario, preco_total, quantidade, imagem_uri, descricao) VALUES ('Pizza Bacon', 49.9, 49.9, 1,'https://raw.githubusercontent.com/devsuperior/sds2/master/assets/pizza_bacon.jpg', 'Pizza de bacon com mussarela, orégano, molho especial e tempero da casa.');
INSERT INTO produto (nome, preco_unitario, preco_total, quantidade, imagem_uri, descricao) VALUES ('Pizza Moda da Casa', 59.9, 59.9, 1, 'https://raw.githubusercontent.com/devsuperior/sds2/master/assets/pizza_moda.jpg', 'Pizza à moda da casa, com molho especial e todos ingredientes básicos, e queijo à sua escolha.');
INSERT INTO produto (nome, preco_unitario, preco_total, quantidade, imagem_uri, descricao) VALUES ('Pizza Portuguesa', 45.0, 45.0, 1, 'https://raw.githubusercontent.com/devsuperior/sds2/master/assets/pizza_portuguesa.jpg', 'Pizza Portuguesa com molho especial, mussarela, presunto, ovos e especiarias.');
...
INSERT INTO produto (nome, preco_unitario, preco_total, quantidade, imagem_uri, descricao) VALUES ('Macarrão Penne', 37.9, 37.9, 1, 'https://raw.githubusercontent.com/devsuperior/sds2/master/assets/macarrao_penne.jpg', 'Macarrão penne fresco ao dente com tempero especial.');
